...
HD_PWD='E:/class/Master of ANU/6213_Digital Systems and Microprocessors/my_6213/lab1/my_adder/my_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_adder.tcl -notrace
